...
st.markdown('---')
st.caption('Use the sidebar slicers to explore date range, category, region, salesperson, customer segment, payment method, and discount range across all visuals.')
